...
set(MSG_I_FLAGS "-Itest_pkg:/home/ljs/myRosspace/src/test_pkg/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ljs/myRosspace/src/test_pkg/msg/MsgTest.msg" NAME_WE)
add_custom_target(_test_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test_pkg" "/home/ljs/myRosspace/src/test_pkg/msg/MsgTest.msg" ""
)
...
_generate_msg_cpp(test_pkg
  "/home/ljs/myRosspace/src/test_pkg/msg/MsgTest.msg"
  "${MSG_I_FLAGS}"
  ""
